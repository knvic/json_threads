 ...
 *
 *Программа ищет файл у которого название содержит partOfName и содержиое partOfName
 *
 */

public class MyFileVisitor1 extends SimpleFileVisitor<Path> {

    String partOfName="json";
    String partOfContent;

    public MyFileVisitor1(String path) {
